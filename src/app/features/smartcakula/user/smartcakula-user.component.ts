...
@Component({
  selector: 'app-smartcakula-user',
  standalone: true,
  imports: [CommonModule, RouterLink],
  template: `
    <div style="padding:24px; max-width: 1100px; margin: 0 auto;">
      <h1 style="margin:0 0 8px;">SmartCakula User</h1>
      ...
      <div style="display:grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 12px;">
        <a routerLink="/smartcakula/manager" style="display:block; padding:16px; border:1px solid rgba(0,0,0,0.1); border-radius:12px; text-decoration:none; color:inherit;">
          ...
          <div style="opacity:0.75; margin-top:6px;">Manager dashboard</div>
        </a>
...
export class SmartCakulaUserComponent {
