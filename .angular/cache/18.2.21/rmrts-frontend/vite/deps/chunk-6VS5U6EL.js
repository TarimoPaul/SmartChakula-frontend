...
var checkDocument = memoize((doc, expectedType) => {
  ...
  if (expectedType) {
    invariant3(operations.length == 1 && operations[0].operation === expectedType, 4, expectedType, expectedType, operations[0].operation);
  }
  visit(doc, {
  ...
  /* defaultCacheSizes["checkDocument"] */
});
...
var KNOWN_DIRECTIVES = ["connection", "include", "skip", "client", "rest", "export", "nonreactive", "stream"];
...
function equalByQuery(query, _a, _c, variables) {
  var _b = _a, {
    data: aData
  } = _b, aRest = __objRest(_b, [
    "data"
  ]);
  var _d = _c, {
    data: bData
  } = _d, bRest = __objRest(_d, [
    "data"
  ]);
...
//# sourceMappingURL=chunk-6VS5U6EL.js.map
